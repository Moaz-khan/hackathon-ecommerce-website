...
// Helper component to render the View All link if provided
const ViewAllLink = ({ viewAllLink }: { viewAllLink: string }) => {
  return (
  ...
  return (
    <section className="max-w-frame mx-auto text-center">
      ...
      <motion.div
        ...
        {viewAllLink && <ViewAllLink viewAllLink={viewAllLink} />}
      </motion.div>
    </section>
  );
};
